...
class SalesOrderShipped implements ObserverInterface
{
    ...
    public function execute(EventObserver $observer)
    {
        ...
        $adminMessage = $this->helper->getAdminMessage('ShipmentNotification');
        ...
        $userMessage = $this->helper->getUserMessage('ShipmentNotification');
